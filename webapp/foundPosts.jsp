...
<title>Found Posts | LostnFound</title>
<%@include file="linkedFiles.jsp"%>
</head>
<body>
<%@include file="navbar.jsp"%>
<div class="container">
<h1 class="mt-3 text-uppercase">Found Posts</h1>
	<div class="row">
<%
	List<Post> posts = Helper.getPostByCat("found");
	if(posts.size()==0){
	...
	for(Post post : posts)
	{
		...
		<div class="col-sm-6">
			<div class="card mt-3 ">
			  <img class="card-img-top m-4" src="pictures/<%= post.getPicture() %>" style="max-width: 490px" alt="<%= post.getPicture() %>">
			  <div class="card-body">
